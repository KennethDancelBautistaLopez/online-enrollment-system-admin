...
export default function Nav({ show }) {
  ...
  const activeLink =
    inactiveLink + " bg-highlight text-black dark:text-white dark:bg-gray-700";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full bg-bgGray dark:bg-gray-900 h-full md:static md:w-auto transition-all"
      }
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname.includes("/students") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        {(session?.user?.role === "admin" ||
          ...
          <Link
            href={"/lists"}
            className={pathname.includes("/lists") ? activeLink : inactiveLink}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              ...
              stroke="currentColor"
              className={
                pathname.includes("/lists") ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
        ...
        {(session?.user?.role === "superAdmin" ||
          ...
          <Link
            ...
            className={
              pathname.includes("/manage-subjects") ? activeLink : inactiveLink
            }
          >
            <div className="flex items-center gap-2">
              <svg
                ...
                fill="currentColor"
                className={
                  pathname.includes("/manage-subjects")
                    ? activeIcon
                    : inactiveIcon
                }
                width="20"
        ...
        {(session?.user?.role === "superAdmin" ||
          ...
          <Link
            href="/sections"
            className={
              pathname.includes("/sections") ? activeLink : inactiveLink
            }
          >
            <div className="flex items-center gap-2">
              <svg
                ...
                fill="currentColor"
                className={
                  pathname.includes("/sections") ? activeIcon : inactiveIcon
                }
                width="20"
                height="20"
              >
        ...
        {(session?.user?.role === "admin" ||
          ...
          >
            <svg
              ...
              strokeWidth={1.5}
              className={
                pathname.includes("/events") ? activeIcon : inactiveIcon
              }
            >
              <path
                fillRule="evenodd"
        ...
        {session?.user?.role === "superAdmin" && (
          <>
            <Link
              href={"/overall"}
              className={
                pathname.includes("/overall") ? activeLink : inactiveLink
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                stroke="currentColor"
                className={
                  pathname.includes("/overall") ? activeIcon : inactiveIcon
                }
              >
                <path
                  strokeLinecap="round"
        ...
        {(session?.user?.role === "superAdmin" ||
          ...
          <Link
            href={"/totalStudents"}
            className={
              pathname.includes("/totalStudents") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              stroke="currentColor"
              className={
                pathname.includes("/totalStudents") ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
        ...
        {(session?.user?.role === "superAdmin" ||
          ...
          <Link
            href={"/all-payments"}
            className={
              pathname.includes("/all-payments") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              stroke="currentColor"
              className={
                pathname.includes("/all-payments") ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
        ...
        {(session?.user?.role === "superAdmin" ||
          ...
          <>
            <Link
              href={"/paymentsPage"}
              className={
                pathname.includes("/paymentsPage") ? activeLink : inactiveLink
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                stroke="currentColor"
                className={
                  pathname.includes("/paymentsPage") ? activeIcon : inactiveIcon
                }
              >
                <path
                  strokeLinecap="round"
        ...
        {session?.user?.role === "superAdmin" && (
          <Link
            href={"/create-admin"}
            className={
              pathname.includes("/create-admin") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              stroke="currentColor"
              className={
                pathname.includes("/create-admin") ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
