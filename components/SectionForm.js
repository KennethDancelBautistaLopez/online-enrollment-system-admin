...
const SectionForm = ({ sectionData: initialData = null }) => {
  ...
  useEffect(() => {
    ...
    setMaxLimit(initialData.maxLimit || []);
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-inner">
        <h3 className="col-span-full text-lg font-semibold text-gray-700 dark:text-gray-200">
          Section Info
        </h3>
      ...
      <div>
        ...
        <div className="space-y-6 max-h-[50vh] overflow-y-auto pr-2">
          {subjects.map((subj, i) => (
            <div
              key={i}
              className="p-4 borde hover:bg-gray-50 dark:hover:bg-gray-800 border rounded-xl bg-gray-100 dark:bg-gray-700 dark:border-gray-600 shadow"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {["monday", "tuesday", "wednesday", "thursday", "friday"].map(
                  (day) => (
                    <div key={day}>
                      <label className="block capitalize text-gray-700 dark:text-gray-300">
                        {day}
                      </label>
                      <select
