        ...
        {(session.user.role === "programHeads" ||
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div className="mb-6 flex justify-between pt-4">
              ...
              <div>
                <Link
                  href="/subjects/view-curriculum"
                  className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 transition-transform hover:scale-105 duration-300 shadow-md px-4 rounded"
                >
                  View Curriculum
                </Link>
              </div>
            ...
            <div className="grid gap-6 mb-6">
              <div className="flex gap-6">
                <select
                  value={form.course}
                  onChange={(e) =>
                    setForm({ ...form, course: e.target.value.toUpperCase() })
                  }
            ...
            {form.subjects.map((subject, index) => (
              <div key={index} className="mb-6">
                <div className="mb-2 flex justify-center items-center">
                  <label className="text-gray-900 dark:text-white block text-lg font-bold mb-2">
                    Subject {index + 1}
                  </label>
                </div>
                <input
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full max-w-xl">
            ...
            {student && (
              <>
                ...
                <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white text-center">
                  Course: {student.course} - Year Level: {student.yearLevel} -
                      ...
                      <div className="flex flex-col md:flex-row justify-between gap-4">
                        <div className="text-gray-800 dark:text-gray-100">
                          <p>
                            ...
                            {subject.description} (units {subject.units})
                          </p>
                        </div>
